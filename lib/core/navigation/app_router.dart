...
import 'package:godsufficient/core/navigation/home_menu_drawer.dart';
    ...
    routes: [
      ...
      StatefulShellRoute.indexedStack(
        builder: (context, state, navShell) {
          ...
          return BlocBuilder<HomeMenuCubit, bool>(
        ...
        branches: [
          ...
          _branchForMega(Mega.community, const [
            Nested.church,
            Nested.volunteer,
          ]),
        ],
        ...
        routes: [
          GoRoute(
            ...
            builder: (context, state) {
              final n = Nested.values.firstWhere(
                (e) => e.path == state.pathParameters['nested'],
              );
          ...
          GoRoute(
            ...
            builder: (context, state) {
              ...
              final a = state.pathParameters['action'] == 'add'
                  ? ActionType.add
                  : ActionType.find;
              return _DoAction(
                nested: n,
                action: a,
              ); // stub for not-yet-built screens
            },
          ),
        ],
      ),
...
StatefulShellBranch _helpBranch() {
  return StatefulShellBranch(
    routes: [
      GoRoute(
        path: '/help',
        builder: (context, state) => _MegaHome(
          mega: Mega.help,
          nested: const [Nested.get_help, Nested.mentor],
        ),
        routes: [
          ...
          GoRoute(
            path: 'get_help/find',
            name: 'help-get-help-find',
            builder: (context, state) => const FindHelpCategoriesPage(),
          ),
          GoRoute(
            ...
            builder: (context, state) => HelpCentersPage(
              ...
              category: state.extra is HelpCategory
                  ? state.extra as HelpCategory
                  : null,
            ),
          ),
          GoRoute(
            path: 'get_help/add',
            name: 'help-get-help-add',
            builder: (context, state) => const AddHelpCenterPage(),
          ),
          // New canonical URLs for your existing pages:
          GoRoute(
            path: 'mentor/find',
            name: 'help-mentor-find',
            builder: (context, state) => const FindMentor(),
          ),
          GoRoute(
            path: 'mentor/add',
            name: 'help-mentor-add',
            builder: (context, state) => BecomeMentor(),
          ),
      ...
      body: ListView.separated(
        ...
        itemBuilder: (context, i) {
          ...
          return ActionCard(
            ...
            icon: switch (n) {
              Nested.apps => AppIcons.apps,
              Nested.learn => AppIcons.learn,
              Nested.get_help => AppIcons.getHelp,
              Nested.mentor => AppIcons.mentor,
              Nested.church => AppIcons.church,
              Nested.volunteer => AppIcons.volunteer,
            },
      ...
      body: Center(
        child: ConstrainedBox(
          ...
          child: SplitActions(
            ...
            onPrimary: () =>
                context.go('/${nested.mega.path}/${nested.path}/find'),
            onSecondary: () =>
                context.go('/${nested.mega.path}/${nested.path}/add'),
          ),
        ),
      ),
    );
